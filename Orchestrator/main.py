...
class AIAnalysisResult:
	...
	Attributes:
		policy:          The access policy generated by the AI.
		raw_response:   The raw JSON response from the AI service.
		used_fallback:   Whether a fallback policy was used.
		model_response: The response from the AI model, if applicable.
	"""
	policy: AccessPolicy
...
class CacheApiClient:
	...
	Two endpoints are used:
	  - GET (via POST): look up an existing policy for a URL + student pair.
