...
          }}>
            <div style={{ fontWeight: 'bold', color: '#4F4A45', fontSize: '17px', position: 'relative', left: '-100px' }}>User Login</div>
          </div>
...
                }}
              >
                <div style={{ fontSize: '20px', position: 'relative', left: '0%', transform: 'translateY(-80%)' }}>Login</div>
              </button>
{/*               <button style={{
